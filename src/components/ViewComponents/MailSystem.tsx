        ...
        <div>
            ...
            >
                ...
                <div className="position-relative" style={{ cursor: "pointer" }} ref={dropdownRef}>
                    ...
                    >
                        <span style={{ fontSize: "14px", fontWeight: 500 }}> <Mail size={17} style={{color: "#1b6de0"}} /> Link with work account</span>
                        <ChevronDown size={16} />
                    </div>
                ...
                <div className="popup-overlay">
                    <div className="popup-box">
                        ...
                        <div className="d-flex justify-content-center gap-3 mt-4">
                            <button className="btn btn-primary" style={{ padding: "6px 20px", borderRadius: "6px" }}>
                                Enable Integration
                            </button>

                            <button className="btn btn-light" style={{ padding: "6px 20px", borderRadius: "6px" }} onClick={() => setShowPopup(false)}>
                                Cancel
                            </button>
                        </div>
                    </div>
