...
const AddVendor = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    sessionStorage.setItem('formSuccess', 'Vendor created');
  ...
  const renderOtherDetailsTab = () => (
    <div className="mx-5">
      <div className="row g-3 three-column-form">
        ...
        <div className="col-lg-4">
          <div className="so-form-group mb-4">
            <label className="so-label text-sm text-muted-foreground fw-bold">PAN:</label>
            <input
              type="text"
        ...
        <div className="col-lg-4">
          <div className="so-form-group mb-4">
            <label className="so-label text-sm text-muted-foreground fw-bold">Payment Terms:</label>
            <select
      ...
      <div className="row mb-4 mt-4 align-items-start">
        <label className="so-label text-sm text-muted-foreground fw-bold mb-2">Documents:</label>
  ...
  const renderAddressTab = () => (
    <div className="mx-5">
      <div className="row g-3 three-column-form">
        ...
        <div className="col-lg-4">
          <div className="so-form-group mb-4">
            <label className="so-label text-sm text-muted-foreground fw-bold">Attention:</label>
            <input
              type="text"
        ...
        <div className="col-lg-4">
          ...
          <div className="so-form-group mb-4">
            <label className="so-label text-sm text-muted-foreground fw-bold">Fax:</label>
            <input
              type="text"
              name="address.fax"
              className="form-control so-control"
            ...
            <table className="table table-sm align-middle item-table-inner">
              <thead>
                <tr>
                  ...
                  <th style={{ width: '60px' }} className="fw-medium text-dark">
                    Action
                  </th>
                </tr>
              </thead>
    ...
    <div className="mx-5">
      <div className="row g-3 three-column-form">
        ...
        <div className="col-lg-4">
          ...
          <div className="so-form-group mb-4">
            <label className="so-label text-sm text-muted-foreground fw-bold">Bank Name:</label>
            <input
              type="text"
        ...
        <div className="col-lg-4">
          <div className="so-form-group mb-4">
            <label className="so-label text-sm text-muted-foreground fw-bold">IFSC:</label>
            <input
              type="text"
