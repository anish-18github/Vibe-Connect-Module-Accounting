...
const costOfGoodsSoldOptions: string[] = ['Job Costing', 'Labour', 'Materials', 'Subcontractor'];
...
export default function AddBudget() {
  ...
  const assetTree: AssetGroup[] = [
      ...
      children: [
        {
          ...
          items: [{ label: 'Accounts Receivable', value: 'Accounts Receivable' }],
        },
        {
    ...
    },
    {
      key: 'fixed-assets',
      label: 'Fixed Assets',
      items: [{ label: 'Furniture and Equipment', value: 'Furniture and Equipment' }],
    },
  ];
        ...
        <form onSubmit={handleSubmit} className="sales-order-form">
          ...
          <div className="so-details-card mx-5 mb-4">
            ...
            <div className="section-divider my-4 mx-n5">
              <h5 className="section-title mb-0 text-muted-foreground">
                      ...
                      return (
                        <li key={name} className="mb-1">
                          ...
                          >
                            <span>{name}</span>
                            {isSelected && (
                              <Check size={14} color="#4a7cc2" style={{ marginLeft: 6 }} />
                            )}
                          </button>
                        </li>
                      );
                        ...
                        <div className="ms-4 mt-1">
                          ...
                          {hasItems && (
                            <ul className="list-unstyled mb-1">
                              {group.items!.map((opt) => {
                                const selected = selectedAssetOptions.includes(opt.value);
                                return (
                          ...
                          {hasChildren && (
                            <ul className="list-unstyled mb-0">
                              {group.children!.map((child) => {
                                const childExpanded = expandedAssetGroups.includes(child.key);
                                return (
