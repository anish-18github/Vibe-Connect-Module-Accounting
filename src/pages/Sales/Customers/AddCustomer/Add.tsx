...
const Add = () => {
  ...
  const calculateIndicatorPosition = () => {
    const activeIndex = ['Other Details', 'Address', 'Contact Persons', 'Remarks'].indexOf(
      activeTab,
    );
  ...
  const renderOtherDetailsTab = () => (
    <div className="row g-4 three-column-form">
      ...
      <div className="col-lg-4">
        <div className="so-form-group mb-4">
          <label className="so-label text-sm text-muted-foreground fw-bold">Portal Language:</label>
          <select
      ...
      <div className="col-12 mt-4">
        <div className="so-form-group mb-4">
          <label className="so-label text-sm text-muted-foreground fw-bold mb-3">Documents:</label>
          <div
